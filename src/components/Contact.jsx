    ...
    <div className='w-full max-w-5xl mx-auto py-20 px-10 xl:px-0 flex justify-center items-center relative'>
      <div className='bg-gray-light border border-gray-darker  w-full md:w-[50%] rounded-2xl p-5 shadow-xl'>
        ...
        >
          ...
          <button
            type='submit'
            className='bg-blue-darker py-3 px-8 outline-none w-fit text-gray-light font-special self-end font-bold shadow-md shadow-primary rounded-xl hover:opacity-90 hover:shadow-lg'
          >
            Send
          </button>
        </form>
