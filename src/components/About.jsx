  ...
  return (
    <div className=' w-full max-w-5xl mx-auto py-20 px-10 xl:px-0'>
      ...
      <p className='text-lg text-gray-darker font-body '>
        Desarrollador Web Frontend autodidacta, en busca de nuevas oportunidades laborales o proyectos freelance para desarrollar sitios web únicos y con personalidad. Estoy constantemente actualizándome y poniendo mis habilidades a prueba con proyectos autónomos. 
      </p>
      <Services/>
    </div>
  )
